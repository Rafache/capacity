export const t = {
  ...
  summary: {
    ...
    calendarUnpublished: 'Les dates scolaires de cette année ne sont pas encore publiées.',
  },
  inputs: {
  ...
  dialogs: {
    ...
    applyDescription: 'La valeur {value} de {field} sera appliquée aux 12 mois de l’année fiscale.',
